...
def verify_face_live(cnic_picture, live_face):
    ...
    # DeepFace and OpenCV histogram comparison are disabled;
    # rely solely on face_recognition for final decision.
    ...
    if 'face_recognition' in verification_result:
        ...
        verification_result['error'] = 'Could not perform face comparison (face_recognition unavailable)'
